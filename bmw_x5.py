# -*- coding: utf-8 -*-
"""
Created on Fri Mar 31 21:05:48 2023
...
text = open("2007/2007_bmw_x5", "r", encoding = "UTF-8")
raw = text.read()
...
textList.dispersion_plot(['bmw', 'car', 'like', 'handling', 'seats', 'idrive', 'drive', 'great', 'new', 'vehicle', 'sport', 'one', 'suv', 'well', 'would', 'interior', 'comfort', 'transmission', 'much', 'love'])
